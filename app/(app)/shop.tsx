  ...
  if (!isMember) {
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.header}><Text style={styles.title}>Tienda</Text></View>
        <View style={styles.emptyContainer}>
          <Text style={styles.emptyIcon}>🛒</Text>
          <Text style={styles.emptyTitle}>Función para miembros</Text>
          <Text style={styles.emptyText}>Asociate a un gym para acceder a la tienda.</Text>
        </View>
      </SafeAreaView>
    );
  }
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.emptyContainer}>
          ...
          <Text style={styles.emptyText}>El gym todavía no cargó productos.</Text>
        </View>
      </SafeAreaView>
    );
  }
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        {products.map((product: any) => {
          ...
          const category = product.category === "product" ? "Producto"
            ...
            <View key={product.id} style={styles.card}>
              ...
              <View style={styles.productInfo}>
                ...
                {product.stock !== null && product.stock <= 3 && product.stock > 0 && (
                  <Text style={styles.lowStock}>⚠ Quedan {product.stock} unidades</Text>
                )}
              </View>
            </View>
          );
      ...
      {totalItems > 0 && (
        <View style={styles.cartBar}>
          <View>
            <Text style={styles.cartItems}>{totalItems} producto{totalItems !== 1 ? "s" : ""}</Text>
...
const styles = StyleSheet.create({
  ...
  imageContainer:      { width: 90, backgroundColor: "#0f172a" },
  image:               { width: 90, height: "100%", resizeMode: "cover" },
  imagePlaceholder:    { width: 90, height: 90, justifyContent: "center", alignItems: "center" },
  ...
  categoryBadge:       { backgroundColor: "#1e3a5f", borderRadius: 6, paddingHorizontal: 6, paddingVertical: 2 },
  ...
  qtyBtn:              { backgroundColor: "#334155", borderRadius: 8, width: 30, height: 30, justifyContent: "center", alignItems: "center" },
  qtyBtnText:          { color: "#f1f5f9", fontSize: 18, fontWeight: "700" },
  qtyValue:            { fontSize: 16, fontWeight: "700", color: "#f1f5f9", minWidth: 20, textAlign: "center" },
  outOfStock:          { backgroundColor: "#334155", borderRadius: 8, paddingHorizontal: 12, paddingVertical: 7 },
  ...
  checkoutBtn:     { backgroundColor: "#fff", borderRadius: 10, paddingHorizontal: 16, paddingVertical: 10 },
